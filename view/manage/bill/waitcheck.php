        ...
        <div class="container-fluid dashboard-content ">
			<div class="all">
				<ul>
				  ...
				  <li class="active"><a href="?pg=bill&act=waitcheck">Chờ xác nhận</a></li>
			...
			<div class="showall" style="margin-top: 10px">
				...
				<div class="row" style="padding: 10px;">
					...
					<div class="col-md-2">
						<a href="?pg=bill&act=waitcheck&next=<?=$item->idbd?>"><button style="padding: 10px 20px; border:1px solid #007bff; color:white;
