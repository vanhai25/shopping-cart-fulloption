        ...
        <div class="container-fluid dashboard-content ">
			<div class="all">
				<ul>
				  ...
				  <li  class="active"><a href="?pg=bill&act=dagiao">Đã giao</a></li>
				  <li><a href="?pg=bill&act=dahuy">Đã huỷ</a></li>
				</ul>
			</div>
			<?php foreach($dagiao as $item): 
			?>
			<div class="showall" style="margin-top: 10px">
				...
				<div class="row" style="padding: 10px;">
					...
					<div class="col-md-2">
						<button style="padding: 10px 20px; border:1px solid #007bff; color:white;
						background: #007bff">Xác Nhận</button>
					</div>
				</div>
